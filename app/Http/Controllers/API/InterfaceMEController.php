...
class ConvertMEcontroller extends Controller
{
    ...
    public function indexColumn(Request $nominterface)
    {
        return InterfaceSoftwareController::getInterfaceSoftware($nominterface);
        // if ($columnindex !== null){
        //     return response()->json(['message' => 'l\'interface a été chargé', 'software' =>  $colonne_matricule ], 200);
        // }
        // else{
        //     // interface spécifique, à tester
        //     $nominterface = 'nom de l\interface' . 'Controller';
        //     $columnindex = $nominterface();
        //     return response()->json(['message' => 'l\'interface a été chargé'], 200); 
        // }
    }
